...
if(isset($_POST['issue_book'])){
    ...
    if(mysqli_num_rows($get_book) > 0){
        ...
        if($book_data['available_quantity'] <= 0){
            ...
            ");
            $new_available =
            $book_data['available_quantity'] - 1;
